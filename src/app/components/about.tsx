...
export default function About() {
    return (
        <div className="AboutDiv">
            ...
            <p className="Discription">I’m Akbar, a passionate <span className="textColor"> Graphic Designer </span> with over 3 years of experience in creating printable sportswear designs.
